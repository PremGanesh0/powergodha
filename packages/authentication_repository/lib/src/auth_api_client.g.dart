...
class _AuthApiClient implements AuthApiClient {
  ...
  Future<LoginApiResponse> login(LoginRequest request) async {
    ...
    final _options = _setStreamType<LoginApiResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late LoginApiResponse _value;
    try {
      _value = LoginApiResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<RegistrationApiResponse> signup(SignupRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<RegistrationApiResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RegistrationApiResponse _value;
    try {
      _value = RegistrationApiResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
